...
perfect_mon_script:
  ...
  .byt  "a great job.",12
  .byt "XThey'd better.",10
  .byt  "Because if one of those",10
  .byt  "lands on my house...",12
...
perfect_thu_script:
  ...
  .byt "YDon't bother; it's probably",10
  .byt  "scripted.  A machine aims",10
  .byt  "the shells on set paths.",12
  ...
  .byt  "there'll certainly",10
  .byt  "be a caTAStrophe.",0
...
discover_clue_1:
  ...
  .byt  "What's that supposed to be?",12
...
discover_clue_3:
  ...
  .byt  "station. I was looking at",10
  .byt  "the evidence,",12
...
end_script:
  ...
  .byt "MThen I'll help fix all",10
  .byt  "your houses.",12
